...
public class TestTimes extends TestIntegration {
	...
	public void testMultiplication1() throws EvaluatorException, OpenMathException {
		assertEquals(24, Evaluator.getNumberResult("6*4", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testMultiplication3() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("7.3*0", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testMultiplication5() throws EvaluatorException, OpenMathException {
		assertEquals(21.17, Evaluator.getNumberResult("7.3*2.9", exerciseVariableMap, fillInVariableMap),0.0001); //<- 21.169999999999998 Verluste aufgrund des IEEE 754 Standarts?
	}

	@Test
	public void testMultiplicationWithNegativeNumber1() throws EvaluatorException, OpenMathException {
		assertEquals(-29, Evaluator.getNumberResult("10*(-2.9)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testMultiplicationWithVariables1() throws EvaluatorException, OpenMathException {
		assertEquals(18, Evaluator.getNumberResult("6*[var=a]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMultiplicationWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(29, Evaluator.getNumberResult("[var=b]*2.9", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testMultiplicationWithVariables4() throws EvaluatorException, OpenMathException {
		assertEquals(10.75, Evaluator.getNumberResult("[var=c]*[var=d]", exerciseVariableMap, fillInVariableMap),0.0001);
	}

	@Test
	public void testMultiplicationWithInput1() throws EvaluatorException, OpenMathException {
		assertEquals(18, Evaluator.getNumberResult("6*[pos=1]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMultiplicationWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(29, Evaluator.getNumberResult("[pos=2]*2.9", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testMultiplicationWithInput4() throws EvaluatorException, OpenMathException {
		assertEquals(10.75, Evaluator.getNumberResult("[pos=3]*[pos=4]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMultiplicationWithEncapsulation1() throws EvaluatorException, OpenMathException {
		assertEquals(8, Evaluator.getNumberResult("2 * (2 * 2)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMultiplicationWithEncapsulation2() throws EvaluatorException, OpenMathException {
		assertEquals(16, Evaluator.getNumberResult("2 * (2 * (2 * 2))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMultiplicationWithEncapsulation3() throws EvaluatorException, OpenMathException {
		assertEquals(64, Evaluator.getNumberResult("2 * (2 * (2 * (2 * (2 * 2))))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
