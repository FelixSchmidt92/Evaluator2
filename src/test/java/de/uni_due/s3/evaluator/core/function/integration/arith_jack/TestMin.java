...
public class TestMin extends TestIntegration {
	...
	public void testMin1() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("min(1, 2)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMin2() throws EvaluatorException, OpenMathException {
		assertEquals(2, Evaluator.getNumberResult("min(3, 2)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMin3() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("min(1, 1)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMin4() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("min(0, 0)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMin5() throws EvaluatorException, OpenMathException {
		assertEquals(-2, Evaluator.getNumberResult("min(-2, 0)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMin6() throws EvaluatorException, OpenMathException {
		assertEquals(-2, Evaluator.getNumberResult("min(-2, 2)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMinWithVariables1() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("min([var=a], [var=b])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMinWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(-1, Evaluator.getNumberResult("min([var=a], [var=c])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMinWithInput1() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("min([pos=1], [pos=2])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMinWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(-1, Evaluator.getNumberResult("min([pos=1], [pos=3])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMinWithExpressions1() throws EvaluatorException, OpenMathException {
		assertEquals(-12, Evaluator.getNumberResult("min(min(-12,2), 4)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMinWithExpressions2() throws EvaluatorException, OpenMathException {
		assertEquals(-12, Evaluator.getNumberResult("min(min(-12,2), min(5, 8))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMinWithExpressions3() throws EvaluatorException, OpenMathException {
		assertEquals(-13, Evaluator.getNumberResult("min(min(-12,min(13,-13)), min(5, 8))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMinWithPointNumbers1() throws EvaluatorException, OpenMathException {
		assertEquals(1.0, Evaluator.getNumberResult("min(1.0, 1.3)", exerciseVariableMap, fillInVariableMap),0.0001);	
	}
