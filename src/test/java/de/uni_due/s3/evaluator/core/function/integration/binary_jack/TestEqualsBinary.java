package de.uni_due.s3.evaluator.core.function.integration.binary_jack;
...
public class TestEqualsBinary extends TestIntegration {
	...
	public void testEqualsBinaryWithInput1() throws EvaluatorException, OpenMathException {
		assertTrue(Evaluator.getBooleanResult("equalsBinary('2','[pos=2][pos=1]')", exerciseVariableMap, fillInVariableMap));
	}
	
	@Test 
	public void testEqualsBinaryWithInput2() throws EvaluatorException, OpenMathException {
		assertTrue(Evaluator.getBooleanResult("equalsBinary('[pos=3]','0111')", exerciseVariableMap, fillInVariableMap));
	}
	
	@Test 
	public void testEqualsBinaryWithVariables1() throws EvaluatorException, OpenMathException {
		assertTrue(Evaluator.getBooleanResult("equalsBinary('2','[var=b][var=a]')", exerciseVariableMap, fillInVariableMap));
	}
	
	@Test 
	public void testEqualsBinaryWithVariables2() throws EvaluatorException, OpenMathException {
		assertTrue(Evaluator.getBooleanResult("equalsBinary('[var=c]','0111')", exerciseVariableMap, fillInVariableMap));
	}
	
	@Test 
	public void testEqualsBinaryWithExpressions() throws EvaluatorException, OpenMathException {
		assertTrue((Evaluator.getBooleanResult("equalsBinary('equalsBinary('3','11')', 'equalsBinary('2','10')')", exerciseVariableMap, fillInVariableMap)));
	}
	...
	@Test (expected=FunctionInvalidArgumentTypeException.class)
	public void testEqualsBinaryWithWrongInputPointNumberAsFirstArgument() throws EvaluatorException, OpenMathException {
