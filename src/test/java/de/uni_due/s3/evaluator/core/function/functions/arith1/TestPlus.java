...
public class TestPlus extends TestFunction {

	static String[][] addition = {
			// Integer
			{ "1+1", "2", "1 + 1" }, // [0]
			{ "1+2", "3", "1 + 2" }, { "2+1", "3", "2 + 1" }, { "plus(1,1)", "2", "1 + 1" },
			{ "plus(1,2)", "3", "1 + 2" }, { "plus(2,1)", "3", "2 + 1" },

			// Float
			{ "plus(1.0, 1.0)", "2", "1.0 + 1.0" }, { "plus(1.0, 2.0)", "3", "1.0 + 2.0" },
	...
	@Test
	public void testPlus() throws FunctionException, ParserException, OpenMathException, CasEvaluationException,
			CasNotAvailableException, NoRepresentationAvailableException, UndefinedFillInVariableException,
			UndefinedExerciseVariableException {
	...
	@Test
	public void testPlusSageSyntax() throws FunctionInvalidNumberOfArgumentsException, CasException,
