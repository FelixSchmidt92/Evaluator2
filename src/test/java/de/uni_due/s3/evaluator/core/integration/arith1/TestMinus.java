...
public class TestMinus extends TestIntegration {
	...
	public void testSubstraction1() throws EvaluatorException, OpenMathException {
		assertEquals(2, Evaluator.getNumberResult("6-4", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstraction2() throws EvaluatorException, OpenMathException {
		assertEquals(4.4, Evaluator.getNumberResult("7.3-2.9", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstraction3() throws EvaluatorException, OpenMathException {
		assertEquals(-7, Evaluator.getNumberResult("3-10", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstraction4() throws EvaluatorException, OpenMathException {
		assertNotEquals(1, Evaluator.getNumberResult("7.3-2", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstraction5() throws EvaluatorException, OpenMathException {
		assertEquals(7.3, Evaluator.getNumberResult("7.3-0", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstraction6() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("0-0", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithVariables1() throws EvaluatorException, OpenMathException {
		assertEquals(3, Evaluator.getNumberResult("6-[var=a]", exerciseVariableMap, fillInVariableMap),0.0001);	
	}
	
	@Test
	public void testSubstractionWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(7.1, Evaluator.getNumberResult("[var=b]-2.9", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithVariables3() throws EvaluatorException, OpenMathException {
		assertEquals(-7, Evaluator.getNumberResult("3-[var=b]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithVariables4() throws EvaluatorException, OpenMathException {
		assertNotEquals(1, Evaluator.getNumberResult("7.3-[var=a]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithVariables5() throws EvaluatorException, OpenMathException {
		assertEquals(7.27, Evaluator.getNumberResult("[var=c]-[var=d]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithInput1() throws EvaluatorException, OpenMathException {
		assertEquals(3, Evaluator.getNumberResult("6-[pos=1]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(7.1, Evaluator.getNumberResult("[pos=2]-2.9", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithInput3() throws EvaluatorException, OpenMathException {
		assertEquals(-7, Evaluator.getNumberResult("[pos=1]-10", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithInput4() throws EvaluatorException, OpenMathException {
		assertNotEquals(1, Evaluator.getNumberResult("7.3-[pos=1]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithInput5() throws EvaluatorException, OpenMathException {
		assertEquals(7.63, Evaluator.getNumberResult("[pos=3]-[pos=4]", exerciseVariableMap, fillInVariableMap),0.0001); //Ergebnis hier 7.629999999999
	}
	
	@Test
	public void testSubstractionWithNegativeNumbers1() throws EvaluatorException, OpenMathException {
		assertEquals(5, Evaluator.getNumberResult("3--2", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testSubstractionWithNegativeNumbers2() throws EvaluatorException, OpenMathException {
		assertEquals(5, Evaluator.getNumberResult("4--1", exerciseVariableMap, fillInVariableMap),0.0001);
	}

	@Test
	public void testSubstractionWithNegativeNumbers3() throws EvaluatorException, OpenMathException {
		assertEquals(7, Evaluator.getNumberResult("7--0", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithEncapsulation1() throws EvaluatorException, OpenMathException {
		assertEquals(3, Evaluator.getNumberResult("5 - (3 - 1)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithEncapsulation2() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("2 - (2 - (2 - 1))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithEncapsulation3() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("2 - (2 - (2 - (2 - (2 - 1))))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithEncapsulation4() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("((((6 - 1) - 1) - 1) - 1) - 1", exerciseVariableMap, fillInVariableMap),0.0001);
	}
