...
public class TestPlus extends TestIntegration {
	...
	public void testAddition1() throws EvaluatorException, OpenMathException {
		assertEquals(10, Evaluator.getNumberResult("6+4", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAddition2() throws EvaluatorException, OpenMathException {
		assertEquals(10.2, Evaluator.getNumberResult("7.3+2.9", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAddition3() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("0.5 + 0.5", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAddition4() throws EvaluatorException, OpenMathException {
		assertEquals(11, Evaluator.getNumberResult("0.5 + 0.5 + 10", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testAdditionWithNegativeNumber2() throws EvaluatorException, OpenMathException {
		assertEquals(-5.3, Evaluator.getNumberResult("-7.3+2", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithNegativeNumber3() throws EvaluatorException, OpenMathException {
		assertEquals(-8, Evaluator.getNumberResult("-2+(-6)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithVariables1() throws EvaluatorException, OpenMathException {
		assertEquals(9, Evaluator.getNumberResult("6+[var=a]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(12.9, Evaluator.getNumberResult("[var=b]+2.9", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithVariables3() throws EvaluatorException, OpenMathException {
		assertEquals(10.5, Evaluator.getNumberResult("[var=c]+7", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithInput1() throws EvaluatorException, OpenMathException {
		assertEquals(9, Evaluator.getNumberResult("6+[pos=1]", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(12.9, Evaluator.getNumberResult("[pos=2]+2.9", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithInput3() throws EvaluatorException, OpenMathException {
		assertEquals(10.5, Evaluator.getNumberResult("[pos=3]+7", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithEncapsulation1() throws EvaluatorException, OpenMathException {
		assertEquals(3, Evaluator.getNumberResult("1 + (1 + 1)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithEncapsulation2() throws EvaluatorException, OpenMathException {
		assertEquals(4, Evaluator.getNumberResult("1 + (1 + (1 + 1))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAdditionWithEncapsulation3() throws EvaluatorException, OpenMathException {
		assertEquals(6, Evaluator.getNumberResult("1 + (1 + (1 + (1 + (1 + 1))))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	@Test(expected=FunctionInvalidArgumentTypeException.class)//es fliegt eine EvaluatorException
