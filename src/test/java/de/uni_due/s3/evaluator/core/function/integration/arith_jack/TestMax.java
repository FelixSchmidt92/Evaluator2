...
public class TestMax extends TestIntegration {
	...
	public void testMax1() throws EvaluatorException, OpenMathException {
		assertEquals(2, Evaluator.getNumberResult("max(1, 2)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMax2() throws EvaluatorException, OpenMathException {
		assertEquals(3, Evaluator.getNumberResult("max(3, 2)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMax3() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("max(1, 1)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMax4() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("max(0, 0)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMax5() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("max(-2, 0)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMax6() throws EvaluatorException, OpenMathException {
		assertEquals(2, Evaluator.getNumberResult("max(-2, 2)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMaxWithVariables1() throws EvaluatorException, OpenMathException {
		assertEquals(2, Evaluator.getNumberResult("max([var=a], [var=b])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMaxWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("max([var=a], [var=c])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMaxWithInput1() throws EvaluatorException, OpenMathException {
		assertEquals(2, Evaluator.getNumberResult("max([pos=1], [pos=2])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMaxWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("max([pos=1], [pos=3])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMaxWithExpressions1() throws EvaluatorException, OpenMathException {
		assertEquals(12, Evaluator.getNumberResult("max(max(12,2), 4)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMaxWithExpressions2() throws EvaluatorException, OpenMathException {
		assertEquals(12, Evaluator.getNumberResult("max(max(12,2), max(5, 8))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMaxWithExpressions3() throws EvaluatorException, OpenMathException {
		assertEquals(13, Evaluator.getNumberResult("max(max(12,max(13,-13)), max(5, 8))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testMaxWithPointNumbers1() throws EvaluatorException, OpenMathException {
		assertEquals(1.3, Evaluator.getNumberResult("max(1.0, 1.3)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
