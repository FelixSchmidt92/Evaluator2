...
public class TestArcSin extends TestIntegration {
	...
	public void testAsin1() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("asin(0)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testAsin5() throws EvaluatorException, OpenMathException {
		assertEquals(0.775397496610753, Evaluator.getNumberResult("asin(0.7)", exerciseVariableMap, fillInVariableMap),0.0001);
	}

	@Test
	public void testAsinWithInput1() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("asin([pos=1])", exerciseVariableMap, fillInVariableMap),0.0001);
	}

	@Test
	public void testAsinWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(PI/2, Evaluator.getNumberResult("asin([pos=2])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAsinWithInput3() throws EvaluatorException, OpenMathException {
		assertNotEquals(PI/2, Evaluator.getNumberResult("asin([pos=3])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAsinWithVariables1() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("asin([var=a])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAsinWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(PI/2, Evaluator.getNumberResult("asin([var=b])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAsinWithVariables3() throws EvaluatorException, OpenMathException {
		assertNotEquals(PI/2, Evaluator.getNumberResult("asin([var=c])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testAsinWithExpressions1() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("asin(asin(asin(0)))", exerciseVariableMap, fillInVariableMap),0.0001);
