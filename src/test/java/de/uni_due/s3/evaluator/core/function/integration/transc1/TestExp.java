...
public class TestExp extends TestIntegration {
	...
	public void testExp2() throws EvaluatorException, OpenMathException {
		assertEquals(2.71828182845, Evaluator.getNumberResult("exp(1)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testExp4() throws EvaluatorException, OpenMathException {
		assertEquals(0.9048374180359595, Evaluator.getNumberResult("exp(-0.1)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testExpWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(22026.465794806718, Evaluator.getNumberResult("exp([pos=2])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testExpWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(22026.465794806718, Evaluator.getNumberResult("exp([var=b])", exerciseVariableMap, fillInVariableMap),0.0001);
	}
