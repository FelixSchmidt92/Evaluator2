 ...
 *
 */
public class TestRandom extends TestFunction {
	...
	@Test
	public void testRandomCaseIntegerationEmptyArguments() throws UndefinedFillInVariableException, UndefinedExerciseVariableException, ParserException, CasEvaluationException, FunctionException, CasNotAvailableException, NoRepresentationAvailableException, OpenMathException {
		OMOBJ p = ExpressionParser.parse("random()", null, null); //Test for Empty Arguments!
