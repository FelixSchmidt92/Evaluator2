...
public class TestCos extends TestIntegration {
	...
	public void testCos1() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("cos('0')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testCos2() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("cos('Pi/2')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testCos3() throws EvaluatorException, OpenMathException {
		assertEquals(-1, Evaluator.getNumberResult("cos('Pi')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testCosWithInput1() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("cos('[pos=1]')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testCosWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(0.5403023058681398, Evaluator.getNumberResult("cos('[pos=2]')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testCosWithInput3() throws EvaluatorException, OpenMathException {
		assertEquals(-1, Evaluator.getNumberResult("cos('[pos=3]')", exerciseVariableMap, fillInVariableMap),0.0001);
	}

	@Test
	public void testCosWithVariables1() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("cos('[var=a]')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testCosWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(0.5403023058681398, Evaluator.getNumberResult("cos('[var=b]')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testCosWithVariables3() throws EvaluatorException, OpenMathException {
		assertEquals(-1, Evaluator.getNumberResult("cos('[var=c]')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testCosWithVariables4() throws EvaluatorException, OpenMathException {
		assertEquals(-1, Evaluator.getNumberResult("cos('[var=PI]')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testCosWithExpression1() throws EvaluatorException, OpenMathException {
		assertEquals(0.5403023058681398, Evaluator.getNumberResult("cos(cos(0))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testCosWithExpression2() throws EvaluatorException, OpenMathException {
		assertEquals(0.8575532158463934, Evaluator.getNumberResult("cos(cos(cos(0)))", exerciseVariableMap, fillInVariableMap),0.0001);
	}
