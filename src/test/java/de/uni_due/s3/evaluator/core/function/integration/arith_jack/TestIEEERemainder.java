package de.uni_due.s3.evaluator.core.function.integration.arith_jack;
...
public class TestIEEERemainder extends TestIntegration {
	...
	public void testIEEERemainder1() throws EvaluatorException, OpenMathException {
		assertEquals(-1, Evaluator.getNumberResult("IEEEremainder(3, 2)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testIEEERemainder2() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("IEEEremainder(4, 2)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testIEEERemainder3() throws EvaluatorException, OpenMathException {
		assertEquals(1, Evaluator.getNumberResult("IEEEremainder(10, 3)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testIEEERemainder4() throws EvaluatorException, OpenMathException {
		assertEquals(-1, Evaluator.getNumberResult("IEEEremainder(11, 3)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testIEEERemainder5() throws EvaluatorException, OpenMathException {
		assertEquals(-1, Evaluator.getNumberResult("IEEEremainder(27, 4)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testIEEERemainder6() throws EvaluatorException, OpenMathException {
		assertEquals(-2, Evaluator.getNumberResult("IEEEremainder(28, 5)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	...
	public void testIEEERemainderWithPointNumberResults1() throws EvaluatorException, OpenMathException {
		assertEquals(1.8, Evaluator.getNumberResult("IEEEremainder(17.8, 4)", exerciseVariableMap, fillInVariableMap),0.0001);   
	}
	
	@Test
	public void testIEEERemainderWithPointNumberResults2() throws EvaluatorException, OpenMathException {
		assertEquals(1.4, Evaluator.getNumberResult("IEEEremainder(17.8, 4.1)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
	
	@Test
	public void testIEEERemainderWithPointNumberResults3() throws EvaluatorException, OpenMathException {
		assertEquals(0.1, Evaluator.getNumberResult("IEEEremainder(-16.3, 4.1)", exerciseVariableMap, fillInVariableMap),0.0001);
	}
...
//		assertEquals("NaN", Evaluator.getResultAsEvaluatorString("IEEEremainder(5, 0)", exerciseVariableMap, fillInVariableMap),0.0001);
//	}
	
	@Test
	public void testIEEERemainderWithInput1() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("IEEEremainder([pos=1], 4)", exerciseVariableMap, fillInVariableMap),0.0001); 
		   
	}
	
	@Test
	public void testIEEERemainderWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("IEEEremainder([pos=2], [pos=3])", exerciseVariableMap, fillInVariableMap),0.0001); 
	}
	
	@Test
	public void testIEEERemainderWithVariables1() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("IEEEremainder([var=a], 4)", exerciseVariableMap, fillInVariableMap),0.0001); 
	}
	
	@Test
	public void testIEEERemainderWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("IEEEremainder([var=b], [var=c])", exerciseVariableMap, fillInVariableMap),0.0001); 
	}
	
	@Test
	public void testIEEERemainderWithExpressions1() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("IEEEremainder('15', 'IEEEremainder(10, 3)')", exerciseVariableMap, fillInVariableMap),0.0001);
		
	}
	
	@Test
	public void testIEEERemainderWithExpressions2() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("IEEEremainder('IEEEremainder(10, 3)', 'IEEEremainder(10, 3)')", exerciseVariableMap, fillInVariableMap),0.0001);
	}
