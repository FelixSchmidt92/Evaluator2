...
public class TestIntervalOO extends TestFunctionAbstract{

	private final Function func = new IntervalOO(); 
	@Test
	public void testIntervallOO() throws EvaluatorException, OpenMathException {
		List<Object> args = new ArrayList<Object>(2);
		args.add(OMCreator.createOMI(1));
		args.add(OMCreator.createOMI(3));
		OMA result = (OMA) func.evaluate(args);
		assertEquals(OMSymbol.INTERVAL1_INTERVALOO,result.getOmel().get(0));
		assertEquals(OMCreator.createOMI(1),result.getOmel().get(1));
		assertEquals(OMCreator.createOMI(3),result.getOmel().get(2));
	}
	
	@Test
	public void testIntervalOOLatexSyntax() throws EvaluatorException, OpenMathException {
		List<Object> args = new ArrayList<Object>(2);
		args.add(OMCreator.createOMI(1));
		args.add(OMCreator.createOMI(3));
