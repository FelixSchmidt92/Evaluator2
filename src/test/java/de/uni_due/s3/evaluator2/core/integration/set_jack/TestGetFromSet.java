...
public class TestGetFromSet extends TestIntegration {
	...
	@Test
	public void testGetFromSet4() throws OpenMathException, EvaluatorException {
		assertEquals(true, Evaluator.getBooleanResult(" '}' ==getFromSet('1', {2;'}';3})", exerVar, fillIn));
	}

	@Test
	public void testGetFromSet5() throws OpenMathException, EvaluatorException {
		assertEquals(3, Evaluator.getNumberResult("getFromSet('2', {2;'}';3})", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSet6() throws OpenMathException, EvaluatorException {
		assertEquals(2, Evaluator.getNumberResult("getFromSet('1', '{1;2;3}')", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSet7() throws OpenMathException, EvaluatorException {
		assertEquals(true, Evaluator.getBooleanResult("'c' == getFromSet('2', '{a;b;c}')", exerVar, fillIn));
	}

	@Test
	public void testGetFromSet8() throws OpenMathException, EvaluatorException {
		assertEquals(42, Evaluator.getNumberResult("getFromSet('3', {a;12;'lalilu';42;-1})", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSet9() throws OpenMathException, EvaluatorException {
	...
	@Test
	public void testGetFromSetWithInput1() throws OpenMathException, EvaluatorException {
		assertEquals(0, Evaluator.getNumberResult("getFromSet('0', '{[pos=1];2;3}')", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSetWithInput2() throws OpenMathException, EvaluatorException {
		assertEquals(-2, Evaluator.getNumberResult("getFromSet('[pos=1]', '{[pos=3];2;3}')", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSetWithInput3() throws OpenMathException, EvaluatorException {
		assertEquals(true,
				Evaluator.getBooleanResult("'e' == getFromSet('[pos=2]', '{a;b;[pos=4]}')", exerVar, fillIn));
	}

	@Test
	public void testGetFromSetWithVariables1() throws OpenMathException, EvaluatorException {
		assertEquals(0, Evaluator.getNumberResult("getFromSet('0', '{[var=a];2;3}')", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSetWithVariables2() throws OpenMathException, EvaluatorException {
		assertEquals(-2, Evaluator.getNumberResult("getFromSet('[var=a]', '{[var=c];2;3}')", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSetWithVariables3() throws OpenMathException, EvaluatorException {
		assertEquals(true,
				Evaluator.getBooleanResult("'e' == getFromSet('[var=b]', '{a;b;[var=d]}')", exerVar, fillIn));
	}

	@Test
	public void testGetFromSetWithPointNumber1() throws OpenMathException, EvaluatorException {
		assertEquals(3.2, Evaluator.getNumberResult("getFromSet('0', '{3.2;2;3}')", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSetWithPointNumber2() throws OpenMathException, EvaluatorException {
		assertEquals(-2.2, Evaluator.getNumberResult("getFromSet('[var=a]', '{-2.2;2;3}')", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSetWithPointNumber3() throws OpenMathException, EvaluatorException {
		assertEquals(true, Evaluator.getBooleanResult("'e.a' == getFromSet('2', {a;b;'e.a'})", exerVar, fillIn));
	}

	@Test
	public void testGetFromSetWithOneRationalAndOneTextArgument() throws OpenMathException, EvaluatorException {
		assertEquals(4, Evaluator.getNumberResult("getFromSet('1', '{2;4;5}')", exerVar, fillIn), 0);
	}

	@Test
	public void testGetFromSetWithTwoTextArguments() throws OpenMathException, EvaluatorException {
		assertEquals(4, Evaluator.getNumberResult("getFromSet('1', '{2;4;5}')", exerVar, fillIn), 0);
	}

	@Test(expected = FunctionInvalidNumberOfArgumentsException.class)
	public void testGetFromSetWithOneArgument() throws OpenMathException, EvaluatorException {
		Evaluator.getNumberResult("getFromSet('3')", exerVar, fillIn);
	}

	@Test(expected = FunctionInvalidNumberOfArgumentsException.class)
	public void testGetFromSetWithThreeArguments() throws OpenMathException, EvaluatorException {
		Evaluator.getNumberResult("getFromSet('4', '{3;1;-7}', '{12;-12}')", exerVar, fillIn);
	}

	@Test(expected = UndefinedFillInVariableException.class)
	public void testGetFromSetWithMissingInput() throws OpenMathException, EvaluatorException {
		Evaluator.getNumberResult("getFromSet('2', '{[pos=42];4;5}')", exerVar, fillIn);
	}

	@Test(expected = UndefinedExerciseVariableException.class)
	public void testGetFromSetWithMissingExerciseVariable() throws OpenMathException, EvaluatorException {
