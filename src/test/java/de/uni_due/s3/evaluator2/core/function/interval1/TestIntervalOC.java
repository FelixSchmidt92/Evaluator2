...
public class TestIntervalOC extends TestFunctionAbstract{

	private final Function func = new IntervalOC(); 
	@Test
	public void testIntervallOC() throws EvaluatorException, OpenMathException {
		List<Object> args = new ArrayList<Object>(2);
		args.add(OMCreator.createOMI(1));
		args.add(OMCreator.createOMI(3));
		OMA result = (OMA) func.evaluate(args);
		assertEquals(OMSymbol.INTERVAL1_INTERVALOC,result.getOmel().get(0));
		assertEquals(OMCreator.createOMI(1),result.getOmel().get(1));
		assertEquals(OMCreator.createOMI(3),result.getOmel().get(2));
	}
	
	@Test
	public void testIntervalOCLatexSyntax() throws EvaluatorException, OpenMathException {
		List<Object> args = new ArrayList<Object>(2);
		args.add(OMCreator.createOMI(1));
		args.add(OMCreator.createOMI(3));
