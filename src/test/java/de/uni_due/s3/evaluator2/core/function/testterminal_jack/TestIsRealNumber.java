...
public class TestIsRealNumber extends TestFunctionAbstract {
	...
	@Test
	public void testIsRealNumberOMIandOMF() throws EvaluatorException, OpenMathException {
	...
	@Test
	public void testIsRealNumberOMSTR() throws EvaluatorException, OpenMathException {
		ArrayList<Object> args = new ArrayList<>();
	...
	@Test
	public void testIsRealNumberOMV() throws EvaluatorException, OpenMathException {
		ArrayList<Object> args = new ArrayList<>();
	...
	@Test
	public void testIsRealNumberOMA() throws EvaluatorException, OpenMathException {
		ArrayList<Object> args = new ArrayList<>();
	...
	@Test
	public void testIsRealNumberOMS_PI() throws EvaluatorException, OpenMathException {
		ArrayList<Object> args = new ArrayList<>();
	...
	@Test
	public void testIsRealNumberOMS_E() throws EvaluatorException, OpenMathException {
		ArrayList<Object> args = new ArrayList<>();
	...
	@Test
	public void testIsRealNumberCaseIntegration1() throws EvaluatorException, OpenMathException {
	...
	@Test
	public void testIsRealNumberCaseIntegration2() throws EvaluatorException, OpenMathException {
	...
	@Test
	public void testIsRealNumberCaseIntegration3() throws EvaluatorException, OpenMathException {
		OMOBJ omobj = ExpressionParser.parse("isRealNumber(sqrt(2))", null, null);
		assertEquals(OMSymbol.LOGIC1_TRUE, OMToResultVisitor.getInstance().visit(omobj));
	}

	@Test
	public void testIsRealNumberCaseIntegration4() throws EvaluatorException, OpenMathException {
		OMOBJ omobj = ExpressionParser.parse("isRealNumber(infinity())", null, null);
		assertEquals(OMSymbol.LOGIC1_FALSE, OMToResultVisitor.getInstance().visit(omobj));
	}
	
	@Test
	public void testIsRealNumberCaseIntegration5() throws EvaluatorException, OpenMathException {
		OMOBJ omobj = ExpressionParser.parse("isRealNumber(3*2)", null, null);
		assertEquals(OMSymbol.LOGIC1_FALSE, OMToResultVisitor.getInstance().visit(omobj));
	}

	@Test
	public void testIsRealNumberCaseIntegration6() throws EvaluatorException, OpenMathException {
		OMOBJ omobj = ExpressionParser.parse("isRealNumber(rational(3,4))", null, null);
		assertEquals(OMSymbol.LOGIC1_TRUE, OMToResultVisitor.getInstance().visit(omobj));
	}
	
	@Test
	public void testIsRealNumberCaseIntegration7() throws EvaluatorException, OpenMathException {
