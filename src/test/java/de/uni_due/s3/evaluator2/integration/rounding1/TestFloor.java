package de.uni_due.s3.evaluator2.integration.rounding1;
...
public class TestFloor extends TestIntegration {
	...
	@Test
	public void testFloor1() throws EvaluatorException, OpenMathException {
		assertEquals(5, Evaluator.getNumberResult("floor(5.4)", exerVar, fillIn), 0);
	}

	@Test
	public void testFloor2() throws EvaluatorException, OpenMathException {
		assertEquals(5, Evaluator.getNumberResult("floor(5.0)", exerVar, fillIn), 0);
	}

	@Test
	public void testFloor3() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("floor(0)", exerVar, fillIn), 0);
	}

	@Test
	public void testFloor4() throws EvaluatorException, OpenMathException {
		assertEquals(-6, Evaluator.getNumberResult("floor(-5.4343664)", exerVar, fillIn), 0);
	}

	@Test
	public void testFloorWithInput1() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("floor([pos=1])", exerVar, fillIn), 0);
	}

	@Test
	public void testFloorWithInput2() throws EvaluatorException, OpenMathException {
		assertEquals(2, Evaluator.getNumberResult("floor([pos=2])", exerVar, fillIn), 0);
	}

	@Test
	public void testFloorWithInput3() throws EvaluatorException, OpenMathException {
		assertEquals(-5, Evaluator.getNumberResult("floor([pos=3])", exerVar, fillIn), 0);
	}

	@Test
	public void testFloorWithVariables1() throws EvaluatorException, OpenMathException {
		assertEquals(0, Evaluator.getNumberResult("floor([var=a])", exerVar, fillIn), 0);
	}

	@Test
	public void testFloorWithVariables2() throws EvaluatorException, OpenMathException {
		assertEquals(2, Evaluator.getNumberResult("floor([var=b])", exerVar, fillIn), 0);
	}

	@Test
	public void testFloorWithVariables3() throws EvaluatorException, OpenMathException {
		assertEquals(-5, Evaluator.getNumberResult("floor([var=c])", exerVar, fillIn), 0);
	}

	@Test
	public void testFloorWithExpressions() throws EvaluatorException, OpenMathException {
		assertEquals(5, Evaluator.getNumberResult("floor(floor(5.1354))", exerVar, fillIn), 0);
	}

	@Test(expected = FunctionInvalidArgumentTypeException.class)
	public void testFloorWithWrongInputCharacter() throws EvaluatorException, OpenMathException {
		Evaluator.getNumberResult("floor(a)", exerVar, fillIn);
	}

	@Test(expected = FunctionInvalidNumberOfArgumentsException.class)
	public void testFloorWithTwoArguments() throws EvaluatorException, OpenMathException {
		Evaluator.getNumberResult("floor(7.4321, 3)", exerVar, fillIn);
	}

	@Test(expected = FunctionInvalidNumberOfArgumentsException.class)
	public void testFloorWithThreeArguments() throws EvaluatorException, OpenMathException {
		Evaluator.getNumberResult("floor(1.434321, 5, 7)", exerVar, fillIn);
	}

	@Test(expected = UndefinedExerciseVariableException.class)
	public void testFloorWithMissingExerciseVariable() throws EvaluatorException, OpenMathException {
		Evaluator.getNumberResult("floor([var=j])", exerVar, fillIn);
	}

	@Test(expected = UndefinedFillInVariableException.class)
	public void testFloorWithMissingInput() throws EvaluatorException, OpenMathException {
