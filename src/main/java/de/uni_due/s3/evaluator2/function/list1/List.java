package de.uni_due.s3.evaluator2.function.list1;
...
public class List extends ConstructorFunction {
	...
	@Override
	protected Object getPartialOpenMathElementResult(java.util.List<Object> arguments) throws FunctionException, CasEvaluationException,
