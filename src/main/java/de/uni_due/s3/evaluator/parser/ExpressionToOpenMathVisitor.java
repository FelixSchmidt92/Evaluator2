...
public class ExpressionToOpenMathVisitor extends EvaluatorParserBaseVisitor<OpenMathObject> {
	 ...
	 */
	@Override
	public OpenMathObject visitIntegerNum(EvaluatorParser.IntegerNumContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public OpenMathObject visitFloatNum(EvaluatorParser.FloatNumContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public OpenMathObject visitFillInVariable(EvaluatorParser.FillInVariableContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public OpenMathObject visitExerciseVariable(EvaluatorParser.ExerciseVariableContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public OpenMathObject visitText(EvaluatorParser.TextContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public OpenMathObject visitIntegerNumber(EvaluatorParser.IntegerNumberContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public OpenMathObject visitFloatNumber(EvaluatorParser.FloatNumberContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public OpenMathObject visitExerciseVar(EvaluatorParser.ExerciseVarContext ctx) {
		return visitChildren(ctx);
	}
	 ...
	 */
	@Override
	public OpenMathObject visitFillInVar(EvaluatorParser.FillInVarContext ctx) {
		return visitChildren(ctx);
	}
