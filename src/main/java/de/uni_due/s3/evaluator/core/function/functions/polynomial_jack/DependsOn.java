...
/**
 * Tests if a given polynomial depends on a specified variable
 * Example: dependsOn("a+1","a") => true
 * @author frichtscheid
 *
 */
public class DependsOn extends Function {
	 ...
	 * The first one is the polynomial, the second one should contain the dependend variable
	 */
	@Override
