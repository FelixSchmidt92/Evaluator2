...
import de.uni_due.s3.evaluator.core.function.arith1.GCD;
...
import de.uni_due.s3.evaluator.core.function.arith1.Root;
import de.uni_due.s3.evaluator.core.function.arith1.Times;
import de.uni_due.s3.evaluator.core.function.arith1.UnaryMinus;
import de.uni_due.s3.evaluator.core.function.arith_jack.IEEERemainder;
import de.uni_due.s3.evaluator.core.function.arith_jack.Max;
import de.uni_due.s3.evaluator.core.function.arith_jack.Min;
import de.uni_due.s3.evaluator.core.function.binary_jack.ConvertToBinary;
import de.uni_due.s3.evaluator.core.function.binary_jack.EqualsBinary;
import de.uni_due.s3.evaluator.core.function.cas_jack.EvaluateInR;
...
import de.uni_due.s3.evaluator.core.function.linalg_jack.RandomMatrixRank;
import de.uni_due.s3.evaluator.core.function.list1.List;
import de.uni_due.s3.evaluator.core.function.logic1.BooleanAnd;
import de.uni_due.s3.evaluator.core.function.logic1.BooleanNot;
...
import de.uni_due.s3.evaluator.core.function.openmath_jack.CountBasicOperations;
...
import de.uni_due.s3.evaluator.core.function.relation1.NotEqual;
...
import de.uni_due.s3.evaluator.core.function.set_jack.GetFromSet;
import de.uni_due.s3.evaluator.core.function.string_jack.CharAt;
import de.uni_due.s3.evaluator.core.function.string_jack.CompareTo;
import de.uni_due.s3.evaluator.core.function.string_jack.CompareToIgnoreCase;
import de.uni_due.s3.evaluator.core.function.string_jack.Concat;
import de.uni_due.s3.evaluator.core.function.string_jack.EndsWith;
import de.uni_due.s3.evaluator.core.function.string_jack.Equals;
import de.uni_due.s3.evaluator.core.function.string_jack.EqualsIgnoreCase;
import de.uni_due.s3.evaluator.core.function.string_jack.IndexOf;
import de.uni_due.s3.evaluator.core.function.string_jack.LastIndexOf;
import de.uni_due.s3.evaluator.core.function.string_jack.Length;
import de.uni_due.s3.evaluator.core.function.string_jack.Matches;
import de.uni_due.s3.evaluator.core.function.string_jack.Replace;
...
import de.uni_due.s3.evaluator.core.function.string_jack.TextValueWithVariables;
import de.uni_due.s3.evaluator.core.function.string_jack.ToLowerCase;
import de.uni_due.s3.evaluator.core.function.string_jack.ToUpperCase;
import de.uni_due.s3.evaluator.core.function.string_jack.Trim;
...
import de.uni_due.s3.evaluator.core.function.testterminal_jack.IsPolynomial;
...
import de.uni_due.s3.evaluator.core.function.transc1.ArcTan;
import de.uni_due.s3.evaluator.core.function.transc1.Cos;
import de.uni_due.s3.evaluator.core.function.transc1.Exp;
import de.uni_due.s3.evaluator.core.function.transc1.Log;
import de.uni_due.s3.evaluator.core.function.transc1.Sin;
import de.uni_due.s3.evaluator.core.function.transc1.Tan;
import de.uni_due.s3.evaluator.core.function.transc2.ArcTan2;
import de.uni_due.s3.evaluator.core.function.transc_jack.ToDegree;
import de.uni_due.s3.evaluator.core.function.transc_jack.ToRadian;
...
//		functions.put(OMSymbol.EVALJACK_EVALPOLYNOMIALCPLX, new EvalPolynomialCplx());
		...
		functions.put(OMSymbol.STRINGJACK_TEXTVALUEWITHVARIABLES, new TextValueWithVariables());
